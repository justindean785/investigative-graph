...
const EntitiesWorkspace = ({
  ...
  const handleCreateLink = async () => {
    ...
    try {
      const response = await axios.post(
        `${API}/investigations/${investigationId}/relationships`,
        newLink,
      );
      ...
      <div className="h-full flex flex-col items-center justify-center p-8">
        <div className="max-w-lg text-center">
          ...
          <p className="text-slate-400 mb-8 leading-relaxed">
            Entities are the building blocks of your investigation - people,
            emails, domains, wallets, and more. Start by adding evidence and
            extracting entities, or add them manually.
          </p>
            ...
            <Dialog open={showLinkDialog} onOpenChange={setShowLinkDialog}>
              ...
              <DialogContent className="glass-strong border-white/10 text-white max-w-md">
                ...
                <div className="space-y-4 mt-4">
                  <div>
                    <Label className="text-xs font-semibold text-cyan-500/80 uppercase tracking-wider">
                      Source Entity
                    </Label>
                    <Select
                      value={newLink.source_entity_id}
                      onValueChange={(value) =>
                        setNewLink({ ...newLink, source_entity_id: value })
                      }
                    >
                      <SelectTrigger
                        data-testid="entities-link-source-select"
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setNewLink({ ...newLink, relationship_type: value })
                      }
                    >
                      <SelectTrigger
                        data-testid="entities-link-type-select"
                        className="mt-2 bg-black/50 border-white/10 text-white"
                      >
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setNewLink({ ...newLink, target_entity_id: value })
                      }
                    >
                      <SelectTrigger
                        data-testid="entities-link-target-select"
                        className="mt-2 bg-black/50 border-white/10 text-white"
                      >
                        <SelectValue placeholder="Select entity" />
                      </SelectTrigger>
                ...
                >
                  ...
                  {isExpanded && connections.length > 0 && (
                    <div className="px-4 pb-4 border-t border-white/5 bg-white/[0.02]">
                      <div className="text-xs text-slate-500 uppercase tracking-wider mt-3 mb-2">
                        Connections
                      </div>
                      <div className="space-y-1">
                        {connections.map((conn) => {
                          ...
                          const connectedTypeInfo = connectedEntity
                            ? getTypeInfo(connectedEntity.kind)
                            : null;
                          ...
                          return (
                            ...
                            >
                              <ArrowRight
                                className={`w-3 h-3 text-slate-500 ${isSource ? "" : "rotate-180"}`}
                              />
                              <span className="text-slate-400">
                                {conn.relType.replace("_", " ")}
                              </span>
                              {connectedEntity && (
                                <span className="text-white inline-flex items-center gap-1.5">
                                  <EntityKindIcon
                                    kind={connectedEntity.kind}
                                    className="w-3.5 h-3.5 shrink-0"
                                    style={{ color: connectedTypeInfo?.color }}
                                  />
            ...
            <div className="space-y-4 mt-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEditEntity({ ...editEntity, value: e.target.value })
                  }
                  className="mt-2 bg-black/50 border-white/10 text-white"
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEditEntity({ ...editEntity, label: e.target.value })
                  }
                  className="mt-2 bg-black/50 border-white/10 text-white"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setEditEntity({ ...editEntity, notes: e.target.value })
                  }
              ...
              <Button
                data-testid="entity-save-edit-button"
...
const EntityForm = ({ newEntity, setNewEntity, onSubmit }) => (
  <div className="space-y-4 mt-4">
    <div>
      ...
      >
        <SelectTrigger
          data-testid="entity-form-type-select"
          className="mt-2 bg-black/50 border-white/10 text-white"
        >
          <SelectValue />
        </SelectTrigger>
