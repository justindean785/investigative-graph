...
export function EntityKindIcon({ kind, className = 'w-4 h-4', strokeWidth = 1.5, style }) {
  const C = ENTITY_KIND_ICONS[kind] || Network;
  return <C className={className} style={style} strokeWidth={strokeWidth} aria-hidden />;
}
